...
RAS_CACHE_PATH : str = None

def set_globals():
    global RAS_APP_NAME, RAS_APP_PATH, RAS_WORKSPACE_PATH, RAS_ROBOT_MODE, RAS_CONFIGS_PATH, RAS_CACHE_PATH
    ...
    RAS_CACHE_PATH = os.path.join(RAS_APP_PATH, 'cache')
